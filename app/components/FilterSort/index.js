...
export default function FilterSort(props) {
  ...
  const { style, modeView, onFilter, onChangeView, onChangeLocationView, type } = props;
  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        <TouchableOpacity onPress={onChangeLocationView} style={styles.contentModeView,{ marginLeft: 12 }}>
          <Icon
            name='map-marker'
            size={16}
            color={BaseColor.grayColor}
...
FilterSort.propTypes = {
  ...
  onChangeLocationView: PropTypes.func,
